    ...
    <div>
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="text-sm px-3 mb-8 w-full md:w-1/3" v-for="artist in artists" :key="artist.id">
                ...
                <p><router-link tag="button" :to="'/artists/' + artist.id" class="text-gray-500 hover:underline font-bold leading-loose focus:outline-none">{{ artist.name }}</router-link></p>
            </div>
        </div>
    </div>
</template>
